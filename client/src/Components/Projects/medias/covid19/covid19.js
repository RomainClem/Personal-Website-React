                    ...
                    <div className="card-body pe-0">
                        ...
                        <Collapse in={open}>
                            <div id="collapse-description" className="mt-2 rounded description">
                                Academic project to apply our learning of JavaFx.
                                We had to use the Model-View-Controller convention. I also chose to use and learn Maven as part of this project.
                            </div>
                        </Collapse>
                        <p className="card-text my-1"><small className="text-muted">Java, JavaFX, Maven, JPA, JUnit, JDBC</small></p>
